...
- Tienes que llamar a `Inicializa` con variables que tienes que declarar tú o preguntadas al jugador si has hecho el `Menu`, no vienen dadas por ejemplo o declaradas de antemano como siempre.
